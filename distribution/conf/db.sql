...
(
    ...
    `real_path`                 VARCHAR(700) NOT NULL COMMENT '文件物理路径',
...
(
    ...
    `real_file_id`   BIGINT(20)   NOT NULL COMMENT '真实文件id',
...
(
    ...
    `real_path`       VARCHAR(700) NOT NULL COMMENT '分片真实的存储路径',
...
(
    `id`          BIGINT       NOT NULL AUTO_INCREMENT COMMENT '主键',
    `log_content` VARCHAR(900) NOT NULL COMMENT '日志内容',
